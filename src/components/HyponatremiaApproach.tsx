...
export const HyponatremiaApproach = () => {
  ...
  return (
    <section className="mt-10 space-y-10 px-4 max-w-screen-md mx-auto">
      ...
      <div>
        ...
        <div className="text-gray-700 space-y-4 text-left">
          <p>
            ...
            effective, and avoids the need to modify dialysate or replacement fluid composition.
          </p>
          ...
          <ul className="list-disc pl-5 text-sm space-y-1">
            ...
            <li><strong>Maximum correction allowed: ≤8 mEq/L increase over 24 hours</strong>.</li>
          </ul>
        </div>
      </div>
      ...
      {/* Precise ACD-A Mitigation Equation */}
      <div>
        <button
          className="flex items-center justify-between w-full text-left text-xl font-semibold mb-2"
