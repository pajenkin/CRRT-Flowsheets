...
import CRRTDiagram from '../assets/CRRTDiagram.svg';
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-2xl font-semibold mb-4 text-blue-800">
        24-Hour Post-Dilution Veno-Venous Hemo-Diafiltration (post-CVVHDF) with Regional Citrate Anticoagulation (RCA)
      </h1>
      <section className="text-gray-700 text-base leading-relaxed space-y-4">
        ...
        <p>
         ...
         <img src={CRRTDiagram} alt="CRRT Diagram" className="mx-auto" />
        <p>
